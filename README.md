...
2. Собрал из sdb1 и sdc2 группу tms-vg и создал 2 логических тома(data, bkp),
 ...
 6. Отмонтировал тестовый том, файлы утратились и еще раз создал файлы file и file1 после монтирования
    
    они остались но после выхода и входа в директорию появились text и text1.
